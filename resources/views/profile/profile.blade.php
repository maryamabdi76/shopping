      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">مشخصات کاربری</h1>
              ...
              <div class="card border-left-purple shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">موجودی کیف پول</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">120000 تومان</div>
                    </div>
                    <div class="col-auto">
                      <a href="/wallet"><i class="fas fa-wallet fa-3x text-gray-300 wallet"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-gray shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">خرید های قبلی</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">3</div>
                    </div>
                    <div class="col-auto">
                      <a href="/lastfactors"><i class="fas fa-file-invoice fa-3x text-gray-300 lastfactors"></i></a>
                    </div>
                  </div>
                </div>
              </div>
